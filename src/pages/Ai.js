...
const Ai = () => {
  return (
    <>
      <SeoHelmet
        title="AI Content Creation, Chatbots & Automation Solutions | Eaximo"
        description="Leverage AI-powered services with Eaximo! From AI content creation and chatbots to predictive analytics and automation, transform your digital marketing strategy with cutting-edge AI solutions."
        url="https://eaximo.com/ai-solutions"
        image="https://eaximo.com/meta-image/ai-solutions.png"
        meta={[
          {
            property: "og:title",
            content:
              "AI Content Creation, Chatbots & Automation Solutions | Eaximo",
          },
          {
            property: "og:description",
            content:
              "Leverage AI-powered services with Eaximo! From AI content creation and chatbots to predictive analytics and automation, transform your digital marketing strategy with cutting-edge AI solutions.",
          },
          {
            property: "og:image",
            content: "https://eaximo.com/meta-image/ai-solutions.png",
          },
          { property: "og:url", content: "https://eaximo.com/ai-solutions" },
          {
            name: "twitter:title",
            content:
              "AI Content Creation, Chatbots & Automation Solutions | Eaximo",
      ...
      <main>
            ...
            <div className="row">
              <div className="col-lg-8">
                ...
                <p className="lead my-5">
                  ...
                  <strong>automated content creation and chatbots</strong> to{" "}
                  <strong>predictive analytics and business automation</strong>,
                  ensuring businesses stay ahead in the competitive digital
                  landscape.
                </p>
                <div className="d-flex flex-wrap gap-3">
                  <Link
                    to="/contact"
                    className="btn btn-primary btn-lg border-0 px-4"
                  >
                    Get AI Solutions
                  </Link>
                  <Link
        ...
        <section className="py-5 my-5" id="services">
          <div className="container">
            ...
            <ul
              className="nav nav-pills mb-5 justify-content-center flex-wrap"
              id="services-tab"
              role="tablist"
            >
            ...
            <div className="tab-content" id="services-tabContent">
              ...
              >
                    ...
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          Data-optimized, AI-assisted content creation with
                          human editing for quality assurance.
                        </p>
                        <div className="mt-3">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          Automated captions, tweets, and engaging content
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          High-quality e-commerce copywriting at scale for your
                          product catalog.
                        </p>
                        <div className="mt-3">
                          <span className="tool-badge">Jasper</span>
                ...
                <div className="text-center mt-5">
                  <Link
                    to="/contact"
                    className="btn btn-primary btn-lg bg-ai-purple border-0 px-5"
                  >
                    Optimize Your Content Creation with AI Today!
                  </Link>
                </div>
              </div>
              ...
              <div className="tab-pane fade" id="seo" role="tabpanel">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-driven SEO optimization with advanced content
                          clustering and keyword analysis.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                            <i className="fas fa-check-circle text-ai-purple me-2"></i>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI tools for improved search rankings with predictive
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          Automated high-converting ad copies for PPC campaigns
                          across platforms.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                ...
                <div className="text-center mt-5">
                  <Link
                    ...
                    className="btn btn-primary btn-lg bg-ai-purple border-0 px-5"
                  >
                    Boost SEO & PPC Campaigns with AI-Powered Insights!
                  </Link>
                </div>
              </div>
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-driven customer engagement through WhatsApp
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          Automated query resolution & virtual assistants for
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-based lead scoring & filtering to prioritize your
                          sales pipeline.
                        </p>
                        <div className="mt-3">
                          <span className="tool-badge">ManyChat</span>
              ...
              <div className="tab-pane fade" id="automation" role="tabpanel">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-driven task automation for business process
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          Smarter customer management solutions with AI-powered
                          CRM integrations.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-driven personalized email sequencing for maximum
                          engagement.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                ...
                <div className="text-center mt-5">
                  <Link
                    ...
                    className="btn btn-primary btn-lg bg-ai-purple border-0 px-5"
                  >
                    Optimize Workflows & Drive Growth with AI Automation!
                  </Link>
                </div>
              </div>
              ...
              <div className="tab-pane fade" id="data" role="tabpanel">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          Custom analytics tools for business intelligence with
                          AI-powered insights.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-driven insights for anticipating customer actions
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-powered industry trend analysis for strategic
                          business scaling.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                ...
                <div className="text-center mt-5">
                  <Link
                    ...
                    className="btn btn-primary btn-lg bg-ai-purple border-0 px-5"
                  >
                    Turn Data into Insights with AI-Powered Analytics!
                  </Link>
                </div>
              </div>
              ...
              <div className="tab-pane fade" id="visual" role="tabpanel">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-assisted templates and automated branding materials
                          creation.
                        </p>
                        <div className="mt-3">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-powered creative branding and logo ideation
                          services.
                        </p>
                        <div className="mt-3">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-enhanced editing, scene selection and content
                          optimization.
                        </p>
                        <div className="mt-3">
                ...
                <div className="text-center mt-5">
                  <Link
                    ...
                    className="btn btn-primary btn-lg bg-ai-purple border-0 px-5"
                  >
                    Enhance Creativity with AI-Driven Visual Solutions!
                  </Link>
                </div>
              </div>
              ...
              <div className="tab-pane fade" id="custom" role="tabpanel">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          Tailored AI model training for specific business needs
                          and datasets.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          Workflow optimization using machine learning for
                          business processes.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="service-card card h-100">
                      <div className="card-body p-4">
                        ...
                        <p className="text-muted">
                          AI-powered application development with custom
                          integrations.
                        </p>
                        <ul className="list-unstyled">
                          <li className="mb-1">
                ...
                <div className="text-center mt-5">
                  <Link
                    ...
                    className="btn btn-primary btn-lg bg-ai-purple border-0 px-5"
                  >
                    Develop Advanced AI Solutions for Your Business!
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="row justify-content-center mb-5">
              <div className="col-lg-8 text-center">
                <h2 className="section-title">
                  Why Choose Eaximo for AI-Powered Services?
                </h2>
                <p className="lead">
              ...
              <div className="col-lg-3 col-md-6">
                <div className="benefit-item">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Integrating the latest AI technologies into business
              ...
              <div className="col-lg-3 col-md-6">
                <div className="benefit-item">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Predictive analytics & AI automation for smarter marketing
                      decisions.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-3 col-md-6">
                <div className="benefit-item">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Tailored AI implementations for branding, sales growth,
                      and operations.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-3 col-md-6">
                <div className="benefit-item">
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      AI-driven chatbot interactions and automation for better
